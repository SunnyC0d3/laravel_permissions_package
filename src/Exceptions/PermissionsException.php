...
class PermissionsException extends Exception
{
    ...
    {
        throw new PermissionsException( "Permission not found.", '1' );
    }

    public static function emptyArguement() 
    {
        throw new PermissionsException( "There are no values provided within the arguement. Please make sure it contains the correct values.", '256' );
    }

    public static function invalidKey( string $value ) 
    {
        throw new PermissionsException( 'The following key - "' . $value . '" cannot be found within the data provided. Please make sure the key provided is part of the array.', '256' );
    }

    public static function exists()
    {
        throw new PermissionsException( "Permission already exists.", '1' );
    }

    public static function hasPermission()
    {
        throw new PermissionsException( "User is already assigned this permission.", '256' );
    }
